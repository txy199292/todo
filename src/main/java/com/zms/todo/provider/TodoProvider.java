...
import com.zms.todo.provider.TodosDatabaseHelper.Tables;
import com.zms.todo.provider.TodosDatabaseHelper.TodoColumn;

import java.util.HashMap;

public class TodoProvider extends ContentProvider {
    protected static final String TAG = "TodoProvider";
    protected static final String AUTHORITY = "com.zms.todo";
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, "todo", TODOS);
        URI_MATCHER.addURI(AUTHORITY, "todo/#", TODOS_ID);
